...
if __name__ == "__main__":
    ...
    if args.noise is None:
        print("No noise being added to the acoustic activations.")
    elif args.noise_gauss:
        print("Adding Gaussian noise with standard deviation " + str(args.noise))
    else:
        print(f"Adding uniform noise on the range ({args.noise}, {args.noise})")
    sys.stdout.flush()
